...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        {
            Intent homeiIntent = new Intent(RegisterActivity.this, ContactActivity.class);
            startActivity(homeiIntent);
            finish();
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(RegisterActivity.this, "Congratulation, you are logged in successfully", Toast.LENGTH_SHORT).show();
